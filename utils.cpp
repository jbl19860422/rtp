...
uint32_t Utils::mpegts_crc32(const uint8_t *data, int len)
{
    register int i;
...
uint32_t Utils::crc32(const void *buf, int size)
{
...
void Utils::scaleI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data, jint dst_width,
    ...
    libyuv::I420Scale((const uint8 *) src_i420_y_data, width,
                      (const uint8 *) src_i420_u_data, (width + 1) >> 1,
                      (const uint8 *) src_i420_v_data, (width + 1) >> 1,
                      width, height,
...
void Utils::rotateI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data, jint degree) {
    jint src_i420_y_size = width * height;
    jint src_i420_u_size = (width >> 1) * (height >> 1);
    ...
    libyuv::I420Rotate((const uint8 *) src_i420_y_data, width,
                       ...
                       (uint8 *) dst_i420_y_data, temp_stride,
                       (uint8 *) dst_i420_u_data, temp_stride >> 1,
                       (uint8 *) dst_i420_v_data, temp_stride >> 1,
                       width, height,
                       (libyuv::RotationMode) degree);
}

void Utils::mirrorI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data) {
    jint src_i420_y_size = width * height;
    jint src_i420_u_size = (width >> 1) * (height >> 1);
...
//NV21转化为YUV420P数据
void Utils::nv21ToI420(jbyte *src_nv21_data, jint width, jint height, jbyte *src_i420_data) {
    //Y通道数据大小
